...
public class SupportDataV2 implements Runnable {
...
//    private static String AccessKey = "eyJ4cC51IjoxNTg0ODA0LCJ4cC5wIjoyLCJ4cC5tIjoiTVRVMU5ERXdORFF6TmprMU13IiwiYWxnIjoiSFMyNTYifQ.eyJleHAiOjE4Njk0NjQ0MzYsImlzcyI6ImNvbS5leHBlcml0ZXN0In0.cuilvVOQwSXcXr2uV9pOzuw3yqhjtSrdUsq-Ilj57xQ";
    private static String baseURL = Main.cloudUser.getCloudFullAdress();
    private static String AccessKey = Main.cloudUser.AccessKey;
...
//        try {
//            collect(true ,false,false, "C:/Users/eyal.kopelevich/Documents/supportData/");
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//    }
